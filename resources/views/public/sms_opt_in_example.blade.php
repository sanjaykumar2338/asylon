    ...
    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 bg-gray-50 space-y-4">
        ...
        <div class="mt-4">
            ...
            <div class="mt-1 bg-white border border-gray-300 rounded-md px-3 py-2 text-gray-800">
                Consent Statement: By digitally signing below and providing my phone number, I agree to receive safety and
                emergency alerts from Asylon via SMS. I understand that message frequency varies based on incident activity
                and that standard message and data rates may apply. I understand I can opt-out at any time by replying STOP
                to any message, or reply HELP for help. My mobile information will not be sold or shared with third parties
