<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->user()?->hasRole(['org_admin', 'platform_admin']))
                        <x-nav-link :href="route('admin.orgs.index')" :active="request()->routeIs('admin.orgs.*')">
                            {{ __('Organizations') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user()?->hasRole(['org_admin', 'platform_admin']))
                <x-responsive-nav-link :href="route('admin.orgs.index')" :active="request()->routeIs('admin.orgs.*')">
                    {{ __('Organizations') }}
                </x-responsive-nav-link>
