<x-admin-layout>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-3 admin-page-header">
            <div>
                <h1 class="h4 mb-1">{{ __('Review Queue') }}</h1>
                <p class="text-muted mb-0 small">{{ __('Review and manage submitted reports.') }}</p>
            </div>
            <div class="d-flex flex-wrap align-items-center justify-content-end" style="gap: 0.5rem;">
                <a href="{{ route('reviews.trash') }}" class="btn btn-outline-secondary btn-sm">
                    <i class="fas fa-trash-alt mr-1"></i> {{ __('View trash') }}
                </a>
                <div class="btn-group btn-group-sm" role="group" aria-label="{{ __('Export reports') }}">
        ...
        <div class="card admin-index-card mb-3">
            <div class="card-body">
                <form method="GET" action="{{ route('reviews.index') }}" class="admin-filter-bar mb-0">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 text-md-end">
                            ...
                            <a href="{{ route('reviews.index') }}" class="btn btn-light btn-sm">
                                {{ __('Clear all') }}
                            </a>
                        </div>
                    </div>
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td class="text-right">
                                        <div class="d-flex flex-wrap justify-content-end align-items-center" style="gap: 0.35rem;">
                                            ...
                                            <a href="{{ route('reports.show', $report) }}" class="btn btn-outline-primary btn-sm">
