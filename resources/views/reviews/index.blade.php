    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-header bg-white d-flex flex-column flex-md-row align-items-md-center justify-content-between">
            <div>
                ...
                <small class="text-muted">{{ __('Narrow the queue by status, risk, or date.') }}</small>
            </div>
            ...
            <form method="GET" action="{{ route('reviews.index') }}">
                <div class="form-row">
                    @if(auth()->user()?->hasRole('platform_admin'))
                        <div class="form-group col-lg-3 col-md-4">
                            ...
                            <select id="org_id" name="org_id" class="form-control form-control-sm">
                    ...
                    <div class="form-group col-lg-3 col-md-4">
                        ...
                        <select id="urgent" name="urgent" class="form-control form-control-sm">
                            <option value="">{{ __('All') }}</option>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-lg-3 col-md-4">
                        ...
                        <select id="risk_level" name="risk_level" class="form-control form-control-sm">
                    ...
                    <div class="form-group col-lg-3 col-md-4">
                        ...
                        <select id="subcategory" name="subcategory" class="form-control form-control-sm" {{ $category === '' ? 'disabled' : '' }}>
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-end align-items-sm-center mt-1">
                    <button type="submit" class="btn btn-primary mr-sm-2 mb-2 mb-sm-0">
                        <i class="fas fa-search mr-1"></i> {{ __('Apply filters') }}
                    </button>
                    <a href="{{ route('reviews.index') }}" class="btn btn-link text-muted text-decoration-none mb-2 mb-sm-0">
                        {{ __('Clear all') }}
                    </a>
                </div>
            </form>
        ...
        <div class="card-header bg-white">
            <div class="d-flex flex-column flex-xl-row align-items-xl-center justify-content-between">
                <div class="mb-3 mb-xl-0">
                    ...
                    <small class="text-muted">{{ __('All reports that match your filters.') }}</small>
                </div>
                <div class="d-flex flex-wrap align-items-center">
                    <a href="{{ route('reviews.trash') }}" class="btn btn-outline-secondary btn-sm mr-2 mb-2">
                        <i class="fas fa-trash-alt mr-1"></i> {{ __('View trash') }}
                    </a>
                    <div class="btn-group btn-group-sm mr-2 mb-2" role="group" aria-label="Export reports">
                        <a href="{{ route('reports.export.list', request()->query()) }}" class="btn btn-outline-primary">
                            <i class="fas fa-file-csv mr-1"></i> {{ __('Export CSV') }}
                        </a>
                        <a href="{{ route('reports.export.list.pdf', request()->query()) }}" class="btn btn-outline-primary">
                            <i class="fas fa-file-pdf mr-1"></i> {{ __('Export PDF') }}
                        </a>
                    </div>
                    <span class="badge badge-info badge-pill px-3 py-2 mb-2">
                    ...
                    <tbody>
                        @forelse ($reports as $report)
                            ...
                            <tr class="align-middle">
                                ...
                                @can('view-all')
                                    <td class="text-nowrap">{{ $report->org?->name ?? __('Unknown') }}</td>
                                @endcan
                        ...
                        @empty
                            <tr>
                                <td colspan="{{ auth()->user()->can('view-all') ? 13 : 12 }}" class="text-center text-muted py-4">
