...
return [
    ...
    'support_email' => env('ASYLON_SUPPORT_EMAIL', 'support@asylon.app'),
    'info_email' => env('ASYLON_INFO_EMAIL', 'info@asylon.app'),
    'ultra_private_mode' => env('ASYLON_ULTRA_PRIVATE_MODE', false),
    'early_adopter_mode' => env('ASYLON_EARLY_ADOPTER', true),
    ...
    'dashboard_url' => env('ASYLON_DASHBOARD_URL', 'https://asylon.app'),
    'audio_transcription' => [
